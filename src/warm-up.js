...
var vegetables = ['asparagus', 'cauliflower', 'broccoli', 'zucchini', 'carrot'];
...
var fruits = ['banana', 'pineapple', 'grape', 'orange', 'apple', 'kiwi', 'mango'];
...
var groceryStore = {
  name: 'King Soopers',
  isOpen: true,
  employees: ['Richard', 'Thomas', 'Madison']
}
